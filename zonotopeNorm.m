function Znorm = zonotopeNorm(Z, p)
% zonotopeNorm - computes the norm of the point p w.r.t. the zonotope-norm
%   induced by the zonotope Z (see [2, Definition 4])
% Syntax:  
%    Znorm = zonotopeNorm(Z,p)
% Inputs:
%    Z - zonotope
%    p - nx1-array, with n the dimension of Z
%
% Outputs:
%    Znorm - zonotope norm of the point p
%
% Example:
%    c = [0;0];
%    G = [[2 3 0];[2 0 3]];
...
[minimizer_p, Znorm, exitflag] = linprog(f, Aineq, bineq, Aeq, beq, [], [], options);
